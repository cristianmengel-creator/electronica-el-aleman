      ...
      >
        ...
        <div className="relative z-10 max-w-5xl">
          ...
          <p className="mt-8 max-w-4xl mx-auto text-lg md:text-xl text-zinc-300 leading-8">
            ...
            <strong>telefonía celular</strong> y{" "}
            <strong>notebooks</strong>. Realizamos{" "}
            <strong>microsoldadura</strong> y reparación electrónica a nivel
            componente, con diagnóstico profesional e instrumental de
            precisión.
          </p>
          ...
          <motion.a
            ...
            href="https://wa.me/5492236988833?text=Hola%20Electronica%20El%20Aleman,%20quiero%20solicitar%20un%20presupuesto"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-12 inline-flex items-center gap-3 bg-green-600 hover:bg-green-500 px-10 py-5 rounded-xl text-xl font-bold transition shadow-2xl"
          >
