        ...
        <nav className="hidden lg:flex gap-7 items-center">
          {menu.map((item) => (
            <a
              key={item.name}
              href={item.link}
              className="text-zinc-300 hover:text-blue-500 transition text-sm font-medium"
            >
              {item.name}
            </a>
          ))}
          ...
          <a
            ...
            className="flex items-center gap-2 bg-white hover:bg-zinc-100 px-4 py-2 rounded-xl transition shadow-md"
          >
            <img
